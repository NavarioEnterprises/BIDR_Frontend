...
# BIDR Reviews Service - Azure Container Instances Deployment Script
# This script builds and deploys the reviews service to Azure Container Instances
...
CONFIG_FILE="$SCRIPT_DIR/reviews-service-config.env"
...
echo "========================================"
echo "🚀 BIDR Reviews Service Deployment"
echo "========================================"
...
az container create \
    ...
    --environment-variables \
        ...
        ALLOW_ANONYMOUS_REVIEWS="$ALLOW_ANONYMOUS_REVIEWS" \
...
# Step 8: Test reviews service
log_step "Step 8: Testing reviews service..."
...
echo "• Reviews API: $PRODUCTION_URL/api/v1/reviews/"
echo "• Ratings API: $PRODUCTION_URL/api/v1/ratings/"
...
log_success "Content Moderation: $CONTENT_MODERATION_ENABLED"
...
echo "3. Test the service via the production domain"

echo ""
echo "🎊 Your reviews service is now deployed and ready for gateway configuration!"
echo "========================================"
