...
# BIDR Resolution Service - Azure Container Instances Deployment Script
# This script builds and deploys the resolution service to Azure Container Instances
...
CONFIG_FILE="$SCRIPT_DIR/resolution-service-config.env"
...
echo "========================================"
echo "🚀 BIDR Resolution Service Deployment"
echo "========================================"
...
az container create \
    ...
    --environment-variables \
        ...
        DB_ENGINE="$DB_ENGINE" \
        DB_NAME="$DB_NAME" \
        DISPUTE_AUTO_ASSIGNMENT="$DISPUTE_AUTO_ASSIGNMENT" \
...
# Step 8: Test resolution service
log_step "Step 8: Testing resolution service..."
...
echo "• Disputes API: $PRODUCTION_URL/api/v1/disputes/"
echo "• Resolution API: $PRODUCTION_URL/api/v1/resolution/"
...
log_success "Notifications: $NOTIFICATIONS_ENABLED"
...
echo ""
echo "🎊 Your resolution service is now deployed and ready for gateway configuration!"
echo "========================================"
