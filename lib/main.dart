...
class MyApp extends StatelessWidget {
  ...
  late final GoRouter _router = GoRouter(
    ...
    redirect: (BuildContext context, GoRouterState state) async {
      ...
      // Debug logging
      print('Router Debug - path: ${state.matchedLocation}');
      print('Router Debug - isLoggedIn: $isLoggedIn');
      print('Router Debug - hasCurrentUser: $hasCurrentUser');
      ...
      if (isAuthenticated &&
        ...
        print('Router Debug - Redirecting to /dashboard from public route');
        return '/dashboard';
      }
      print('Router Debug - No redirect needed, allowing navigation');
      return null;
    },
    routes: [
      // Landing/Login Route
      ...
      GoRoute(
        ...
        pageBuilder: (BuildContext context, GoRouterState state) {
          return CustomTransitionPage(
            key: state.pageKey,
            child: BidrPasswordResetFlow(), // Role selection screen
            transitionsBuilder:
            ...
            child: Column(
              children: [
                if (kIsWeb) ...[
                  ...
                  ResetPasswordMobileScreen(uid: uid, token: token),
