    ...
    return FutureBuilder<Map<String, dynamic>>(
      ...
      builder: (context, snapshot) {
        ...
        if (kDebugMode) {
          ...
          print(
            'HomeRouter Debug - loginData length: ${loginData?.length ?? 0}',
          );
          print(
            'HomeRouter Debug - Constants.currentUser: ${Constants.currentUser?.toJson()}',
          );
        }
        ...
        if (userRole == null || userRole.isEmpty) {
          if (loginData != null && loginData.isNotEmpty) {
            try {
              ...
              print(
                'HomeRouter Debug - Routing by login data role: ${loginResponse.user.role.toLowerCase()}',
              );
              switch (loginResponse.user.role.toLowerCase()) {
                ...
                default:
                  print(
                    'HomeRouter Debug - Unknown role, showing login prompt',
                  );
                  return _buildLoginPrompt(context);
              }
            } catch (e) {
        ...
        print(
          'HomeRouter Debug - Routing by userRole: ${userRole.toLowerCase()}',
        );
