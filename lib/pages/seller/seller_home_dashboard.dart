...
import 'package:bidr/models/product_request_api.dart';
...
class _SellerDashboardState extends State<SellerDashboard>
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          else if (isLoadingRequests && _isInitialRequestsLoad)
            Center(
              child: Padding(
                  ...
                  Expanded(
                    child: MouseRegion(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          // TODO: Navigate to detail screen when request data is available
    ...
    return AnimatedContainer(
      ...
      child: MouseRegion(
        ...
        child: InkWell(
          ...
          hoverColor: Constants.ftaColorLight.withOpacity(0.1),
          splashColor: Constants.ftaColorLight.withOpacity(0.2),
          highlightColor: Constants.ftaColorLight.withOpacity(0.1),
          onTap: () {
  ...
  Widget _buildNavItem(
    ...
    final isHovering = _navItemHoverStates[title] ?? false;
