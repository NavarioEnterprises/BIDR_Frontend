...
class AccountManagementMobile extends StatefulWidget {
  ...
  @override
  State<AccountManagementMobile> createState() => _AccountManagementMobileState();
}
...
class _AccountManagementMobileState extends State<AccountManagementMobile>
                ...
                children: [
                  ...
                  Theme(
                    ...
                    child: TabBar(
                      ...
                      indicatorWeight: 3,
                      indicatorPadding: EdgeInsets.symmetric(horizontal: spacing.spacingSmall),
  ...
  Widget _buildEditProfileContent(TypographyConfig typography, SpacingConfig spacing) {
  ...
  Widget _buildChangePasswordContent(TypographyConfig typography, SpacingConfig spacing) {
    return SingleChildScrollView(
      padding: EdgeInsets.all(spacing.paddingLarge),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildGetQuotesContent(TypographyConfig typography, SpacingConfig spacing) {
    return SingleChildScrollView(
      padding: EdgeInsets.all(spacing.paddingLarge),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildMessageBoardContent(TypographyConfig typography, SpacingConfig spacing) {
    return SingleChildScrollView(
      padding: EdgeInsets.all(spacing.paddingLarge),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildDeleteAccountContent(TypographyConfig typography, SpacingConfig spacing) {
    return SingleChildScrollView(
      padding: EdgeInsets.all(spacing.paddingLarge),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Widget _buildSignOutContent(TypographyConfig typography, SpacingConfig spacing) {
    return SingleChildScrollView(
      padding: EdgeInsets.all(spacing.paddingLarge),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
