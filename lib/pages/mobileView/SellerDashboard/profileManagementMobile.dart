...
class ProfileManagementMobile extends StatefulWidget {
  ...
  @override
  State<ProfileManagementMobile> createState() =>
      _ProfileManagementMobileState();
}
...
class _ProfileManagementMobileState extends State<ProfileManagementMobile>
  ...
  void _navigateToGetQuote() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => GetQuotePage()),
    );
  }
...
class _EditSellerProfilePageState extends State<EditSellerProfilePage>
    ...
    switch (sectionTitle) {
      ...
      case 'Displayed On Platform':
        page = DisplayedOnPlatformPage(
          ...
          onRegisteredNameChanged: (value) =>
              setState(() => registeredName = value),
  ...
  void _populateFields() {
    ...
    if (productSubcategory != null) {
      ...
      categories.forEach((key, value) {
        categories[key] = _mapBackendCategoryToFrontend(
          productSubcategory,
          key,
        );
      });
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  foregroundColor: Colors.white,
                  padding: EdgeInsets.symmetric(
                    vertical: spacing.paddingMedium + 8,
                  ),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(360),
                  ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Category checkboxes
            ..._localCategories.entries
                .map(
                  (entry) =>
                      _buildCategoryCheckbox(entry.key, entry.value, spacing),
                )
                .toList(),
...
class DisplayedOnPlatformPage extends StatefulWidget {
  ...
  @override
  _DisplayedOnPlatformPageState createState() =>
      _DisplayedOnPlatformPageState();
}

class _DisplayedOnPlatformPageState extends State<DisplayedOnPlatformPage>
    with SnackBarMixin {
  bool _isLoading = false;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildCheckboxField('Use Registered Name', _localRegisteredName, (
              bool? value,
            ) {
              setState(() {
                        ...
                        return Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: Constants.ctaColorLight.withOpacity(
                                    0.3,
                                  ),
                                  blurRadius: 20,
                                  spreadRadius: 5,
