...
class _RatingReviewMobileState extends State<RatingReviewMobile> {
  ...
  Widget _buildVerticalReviewsList(
    TypographyConfig typography,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Container(height: 10, width: 2, color: Constants.ctaColorLight),
              SizedBox(width: spacing.spacingSmall),
              Expanded(
                child: ResponsiveText(
                  text:
                      'ID: ${review.uuid.length >= 8 ? review.uuid.substring(0, 8) : review.uuid}',
                  type: TextType.normal,
            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  onPressed: () =>
                      _showRespondDialog(review, typography, spacing),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Constants.ctaColorLight,
                    foregroundColor: Colors.white,
                    elevation: 2,
              ...
              Expanded(
                child: ElevatedButton(
                  onPressed: () =>
                      _showReportDialog(review, typography, spacing),
                  style: ElevatedButton.styleFrom(
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          style: TextStyle(fontSize: typography.normal, color: Colors.black87),
          decoration: InputDecoration(
