...
class PinEntryMobileDialog extends StatefulWidget {
  final Function(String pin)? onPinCompleted;
  final Function()? onCancel;
  final int pinLength;

  const PinEntryMobileDialog({
    Key? key,
    this.onPinCompleted,
    this.onCancel,
    this.pinLength = 4,
  ...
  @override
  _PinEntryMobileDialogState createState() => _PinEntryMobileDialogState();
}

class _PinEntryMobileDialogState extends State<PinEntryMobileDialog> {
