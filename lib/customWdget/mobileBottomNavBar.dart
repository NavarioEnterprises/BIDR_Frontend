            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _buildNavItem(1, HugeIcons.strokeRoundedDashboardSquare01, 'Categories'),
                  const SizedBox(width: 70), // Space for center button
                  _buildNavItem(3, HugeIcons.strokeRoundedCustomerSupport, 'Support'),
...
class CurvedPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(
      size.width * 0.5, 45, // Control point at center, pushed down
      size.width, 10,
    );
