...
class ProductRequestItem {
  ...
  final String buyerId; // Changed to String to match API response
  ...
  final Map<String, dynamic>? vehicleSparesData;
  final Map<String, dynamic>? vehicleTyresRimsData;
  final Map<String, dynamic>? consumerElectronicsData;
  ...
  ProductRequestItem({
    ...
    this.vehicleSparesData,
    this.vehicleTyresRimsData,
    this.consumerElectronicsData,
  ...
  factory ProductRequestItem.fromJson(Map<String, dynamic> json) {
    return ProductRequestItem(
      ...
      buyerLocation: json['buyer_location'] as Map<String, dynamic>?,
      ...
      vehicleSparesData: json['vehicle_spares_data'] as Map<String, dynamic>?,
      vehicleTyresRimsData: json['vehicle_tyres_rims_data'] as Map<String, dynamic>?,
      consumerElectronicsData: json['consumer_electronics_data'] as Map<String, dynamic>?,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'vehicle_spares_data': vehicleSparesData,
      'vehicle_tyres_rims_data': vehicleTyresRimsData,
      'consumer_electronics_data': consumerElectronicsData,
