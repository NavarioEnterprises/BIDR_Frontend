...
enum VettingStatus { pending, approved, declined }

enum UserRole { administrator, buyer, seller }
...
class AppUser {
  ...
  factory AppUser.fromJson(Map<String, dynamic> json) {
    return AppUser(
      ...
      dateJoined:
          DateTime.tryParse(json['date_joined'] ?? '') ?? DateTime(2000),
...
class Seller {
  ...
  factory Seller.fromJson(Map<String, dynamic> json) => Seller(
    ...
    productSubcategory: _productSubcategoryFromString(
      json['product_subcategory'],
    ),
    createdAt: DateTime.tryParse(json['created_at'] ?? '') ?? DateTime(2000),
    updatedAt: DateTime.tryParse(json['updated_at'] ?? '') ?? DateTime(2000),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    'product_subcategory': productSubcategory != null
        ? _productSubcategoryToString(productSubcategory!)
        : null,
    'created_at': createdAt.toIso8601String(),
    'updated_at': updatedAt.toIso8601String(),
  };
...
class BuyersAddressDetails {
  ...
  factory BuyersAddressDetails.fromJson(Map<String, dynamic> json) =>
      BuyersAddressDetails(
        uid: json['uid'] ?? '',
        user: AppUser.fromJson(json['user'] ?? {}),
        ...
        contactPersonEmailAddress: json['contact_person_email'] ?? '',
        platformWorkflowEmailAddress: json['platform_workflow_email'] ?? '',
  ...
  Map<String, dynamic> toJson() => {
    ...
    'contact_person_email': contactPersonEmailAddress,
    'platform_workflow_email': platformWorkflowEmailAddress,
