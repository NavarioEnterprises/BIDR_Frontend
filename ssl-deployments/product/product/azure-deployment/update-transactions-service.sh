...
# BIDR transactions Service Update Script
set -e
echo "🔄 Updating BIDR transactions Service..."
...
echo "🎉 transactions Service Updated!"
echo "Image Tag: $NEW_TAG"
echo "Container State: $CONTAINER_STATE"
echo "Service URL: http://${NEW_FQDN}:${transactions_8006}"
echo "🎯 Health Check: curl http://${NEW_FQDN}:${transactions_8006}/health/"
