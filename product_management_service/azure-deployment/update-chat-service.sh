...
# BIDR Chat Service Update Script
# This script rebuilds and redeploys the chat service

set -e

echo "🔄 Updating BIDR Chat Service..."
...
echo "az container logs --resource-group $RESOURCE_GROUP --name $CONTAINER_NAME"
echo ""
echo "🎊 Chat Service update complete!"
echo "========================================"
