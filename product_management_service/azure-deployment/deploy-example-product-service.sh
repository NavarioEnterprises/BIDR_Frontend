...
# BIDR Product Service Deployment Script (Example Usage)
# This is an example of how to use the template for the product service
set -e

# Configuration - Customized for Product Service
...
echo -e "${BLUE}• Product API: http://$CONTAINER_FQDN:$SERVICE_PORT/api/products/${NC}"
echo -e "${BLUE}• Categories API: http://$CONTAINER_FQDN:$SERVICE_PORT/api/categories/${NC}"
