...
# BIDR reviews Service Deployment Script
set -e
echo "🚀 Deploying BIDR reviews Service..."
...
echo "🎉 reviews Service URL: http://${CONTAINER_FQDN}:${reviews_8007}"
echo "🎯 Health Check: curl http://${CONTAINER_FQDN}:${reviews_8007}/health/"
