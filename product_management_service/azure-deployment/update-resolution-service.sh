...
# BIDR resolution Service Update Script
set -e
echo "🔄 Updating BIDR resolution Service..."
...
echo "🎉 resolution Service Updated!"
echo "Image Tag: $NEW_TAG"
echo "Container State: $CONTAINER_STATE"
echo "Service URL: http://${NEW_FQDN}:${resolution_8004}"
echo "🎯 Health Check: curl http://${NEW_FQDN}:${resolution_8004}/health/"
