...
# BIDR Chat Service Enhanced Update Script with Application Gateway Support
...
echo "🚀 BIDR Chat Service Enhanced Deployment Manager"
echo "================================================"
...
DOMAIN_NAME="chat-service.bidr.co.za"
...
# Function to get the chat service directory path
get_service_directory() {
    SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
    CHAT_SERVICE_DIR="$(dirname "$(dirname "$SCRIPT_DIR)")/chat_service"
...
deploy_container() {
    print_header "🐳 Deploying Chat Service Container"
    ...
    echo ""
    echo "========================================"
    print_header "🎉 Chat Service Container Updated!"
    echo "========================================"
...
main() {
    ...
    while true; do
        ...
        case $choice in
            1)
                ...
                ;;
            2)
                print_header "🚀 Full Deployment: Container + HTTPS Gateway"
                deploy_container
                if [ $? -eq 0 ]; then
                    echo ""
                    configure_application_gateway
    ...
    echo "========================================"
    echo "Service: BIDR Chat Service"
    ...
    print_success "Chat Service deployment completed! 🎉"
}
